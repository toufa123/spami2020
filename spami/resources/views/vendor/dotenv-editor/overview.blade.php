...
@section('content')
    <div id="app">
        ...
        <div class="container">
            <h1><a href="{{ url(config('dotenveditor.route.prefix')) }}">{{ trans('dotenv-editor::views.title') }}</a>
            </h1>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="editvalue">{!! trans('dotenv-editor::views.overview_edit_modal_value') !!}</label>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form @submit.prevent="addNew()">
                                    <div class="form-group">
                                        <label
                                            for="newkey">{!! trans('dotenv-editor::views.addnew_label_key') !!}</label>
                                        <input type="text" name="newkey" id="newkey" v-model="newEntry.key"
                                               class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label
                                            for="newvalue">{!! trans('dotenv-editor::views.addnew_label_value') !!}</label>
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        <span class="glyphicon glyphicon-refresh"
                                                              title="{!! trans('dotenv-editor::views.backup_table_options_restore') !!}"></span>
                                                    </a>
                                                    <a href="{{ url(config('dotenveditor.route.prefix') . "/download/" . $backup['unformatted']) }}">
                                                        <span class="glyphicon glyphicon-download"
                                                              title="{!! trans('dotenv-editor::views.backup_table_options_download') !!}"></span>
                                                    </a>
